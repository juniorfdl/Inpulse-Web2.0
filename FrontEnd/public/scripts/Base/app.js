...
/*	App.modules.App.config(['$qProvider', function ($qProvider) {
    ...
    App.modules.App.config(function (easyMaskProvider) {
        ...
        easyMaskProvider.publishMask('ddd+fone', '99099999999');
        easyMaskProvider.publishMask('data', '99/99/9999');
        easyMaskProvider.publishMask('hora', '99:99');
    });
    ...
    App.modules.App.factory('beforeUnload', function ($rootScope, $window) {
    ...
    App.modules.App.run(function (beforeUnload) {
