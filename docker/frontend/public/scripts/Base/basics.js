...
(function (App) {
    ...
    var modules = (function () {
        ...
        modules.App = angular.module('app', ['ngAnimate', 'textAngular', 'ngMessages', 'ngLocale',
            'app.init', 'ui.router', 'ui.bootstrap', 'ui.select',
            'unsavedChanges',  'oitozero.ngSweetAlert', 'toaster',  'wt.easy', 'wt.apps', 'wt.smart', 'wt.responsive', 
            'ngCpfCnpj', 
            'app.infra', 'app.filters', 'app.services', 'app.directives', 'app.controllers',
            'ngMaterial', 'material.svgAssetsCache', 'timer', 'angular-svg-round-progressbar',
            'naif.base64'
        ]);
        return modules;
    })();
